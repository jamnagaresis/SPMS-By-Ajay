...
const primaryBrand = [30, 58, 138]; // Blue 900 (Deep, modern)
const accentColor = [14, 165, 233]; // Sky 500 (Vibrant accent)
const darkSlate = [15, 23, 42]; // Slate 900
const borderSlate = [203, 213, 225]; // Slate 300
const textMuted = [71, 85, 105]; // Slate 600
const textDark = [30, 41, 59]; // Slate 800

const successBg = [240, 253, 244]; // Green 50
const successText = [21, 128, 61]; // Green 700
const successBorder = [34, 197, 94]; // Green 500

const dangerText = [220, 38, 38]; // Red 600
...
const finalYTable = doc.lastAutoTable.finalY || 400;
